...
func TestVegapulsSensorPacketIdentifier2(t *testing.T) {
	is, _ := testSetup(t)
	ue, err := facades.New("netmore")(context.Background(), "payload", []byte(fmt.Sprintf(testData, packetIdentifier2)))
	is.NoErr(err)
...
func TestVegapulsSensorPacketIdentifier8(t *testing.T) {
	is, _ := testSetup(t)
	ue, err := facades.New("netmore")(context.Background(), "payload", []byte(fmt.Sprintf(testData, packetIdentifier8)))
	is.NoErr(err)
...
func TestVegapulsSensorConvertsFromInchesToMeters(t *testing.T) {
	is, _ := testSetup(t)
	ue, err := facades.New("netmore")(context.Background(), "payload", []byte(fmt.Sprintf(testData, testDataInFeet)))
	is.NoErr(err)
...
func TestVegapulsSensorConvertsFromFahrenheitToCelsius(t *testing.T) {
	is, _ := testSetup(t)
	ue, err := facades.New("netmore")(context.Background(), "payload", []byte(fmt.Sprintf(testData, testDataFahrenheit)))
	is.NoErr(err)
...
func TestVegapulsSensorReturnsErrOnIncompletePayload(t *testing.T) {
	is, _ := testSetup(t)
	ue, err := facades.New("netmore")(context.Background(), "payload", []byte(fmt.Sprintf(testData, partialTestData)))
	is.NoErr(err)
...
func TestVegapulsSensorReturnsErrOnUnknownPacketIdentifier(t *testing.T) {
	is, _ := testSetup(t)
	ue, err := facades.New("netmore")(context.Background(), "payload", []byte(fmt.Sprintf(testData, unknownPacketIdentifier)))
	is.NoErr(err)
...
func TestVegapulsSensorPacketIdentifier12(t *testing.T) {
	is, _ := testSetup(t)
	ue, err := facades.New("netmore")(context.Background(), "payload", []byte(fmt.Sprintf(testData, packetIdentifier12)))
	is.NoErr(err)
