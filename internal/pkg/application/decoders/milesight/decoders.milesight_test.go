...
func TestMilesightAM100Decoder(t *testing.T) {
	is, _ := testSetup(t)
	ue, _ := facades.New("servanet")([]byte(data_am100))
...
func TestMilesightEM500Decoder(t *testing.T) {
	...
	ue, _ := facades.New("servanet")([]byte(data_em500))
...
func TestMilesightDecoderEM400TLD(t *testing.T) {
	...
	ue, _ := facades.New("servanet")([]byte(data_em400))
	payload, err := Decoder(context.Background(), ue)
	is.NoErr(err)
	objects, err := Converter(context.Background(), "devid", payload, ue.Timestamp)
	is.NoErr(err)
...
func TestMilesightDecoderEM400TLD2(t *testing.T) {
	...
	ue, _ := facades.New("servanet")([]byte(data_em400_tld))
	payload, err := Decoder(context.Background(), ue)
	is.NoErr(err)
	objects, err := Converter(context.Background(), "devid", payload, ue.Timestamp)
	is.NoErr(err)
...
func TestMilesightDecoderEM400UDL(t *testing.T) {
	...
	ue, _ := facades.New("servanet")([]byte(data_em400_udl))
	payload, err := Decoder(context.Background(), ue)
	is.NoErr(err)
	objects, err := Converter(context.Background(), "devid", payload, ue.Timestamp)
	is.NoErr(err)
...
func TestMilesightDecoderEM400TLD_NegTemp(t *testing.T) {
	...
	ue, _ := facades.New("servanet")([]byte(data_em400_tld_neg))
	payload, err := Decoder(context.Background(), ue)
	is.NoErr(err)
	objects, err := Converter(context.Background(), "devid", payload, ue.Timestamp)
	is.NoErr(err)
...
func TestMilesightEM300Decoder(t *testing.T) {
	is := is.New(t)
	ue, _ := facades.New("servanet")([]byte(data_em300))
