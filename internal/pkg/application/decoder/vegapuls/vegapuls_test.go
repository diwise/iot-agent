...
func TestVegapulsSensorReturnsErrOnIncompletePayload(t *testing.T) {
	is, _ := testSetup(t)
	ue, err := application.Netmore([]byte(partialTestData))
	is.NoErr(err)
...
func TestVegapulsSensorReturnsErrOnUnknownPacketIndicator(t *testing.T) {
	is, _ := testSetup(t)
	ue, err := application.Netmore([]byte(unknownTestData))
	is.NoErr(err)
...
const partialTestData string = `[{
	"devEui":"c4ac590000ccc60d",
	"deviceName":"vegapuls_air_41",
	"sensorType":"vegapuls_air_41",
	"fPort":"1",
	"payload":"02003FA31F152D2400FA",
	"timestamp":"2024-02-28T11:21:59.626943Z",
	"rxInfo":{
		"gatewayId":"274",
		"rssi":-107,"snr":4
...
const unknownTestData string = `[{
	"devEui":"c4ac590000ccc60d",
	"deviceName":"vegapuls_air_41",
	"sensorType":"vegapuls_air_41",
	"fPort":"1",
	"payload":"05003FA31F152D2400FA",
	"timestamp":"2024-02-28T11:21:59.626943Z",
	"rxInfo":{
		"gatewayId":"274",
		"rssi":-107,"snr":4
